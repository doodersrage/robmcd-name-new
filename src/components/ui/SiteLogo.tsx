...
function LogoMark({ compact = false }: { compact?: boolean }) {
  return (
    ...
    >
      ...
      <path
        d="M8 24V8h8.2c3.3 0 5.5 1.9 5.5 4.8 0 2.3-1.4 4-3.6 4.6L24 24h-3.4l-5.4-6.2H11V24H8Zm3-9.1h5c1.8 0 2.9-1 2.9-2.4S17.8 10 16 10H11v4.9Z"
        fill="currentColor"
      />
    </svg>
  )
...
export function SiteLogo({
  ...
  return (
    <a className={logoClasses} href="/" aria-label={ariaLabel}>
      {content}
    </a>
  )
}
