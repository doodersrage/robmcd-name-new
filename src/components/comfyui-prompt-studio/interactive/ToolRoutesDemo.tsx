...
const TOOLS = [
  ...
  { route: '/play', label: 'Film', slug: 'play/cast' },
  { route: '/moodboard', label: 'Look', slug: 'play/cast' },
  { route: '/fitting', label: 'Outfit', slug: 'play/cast' },
  { route: '/day', label: 'Day', slug: 'play/story' },
  { route: '/story', label: 'Story', slug: 'play/story' },
